...
const navbar = () => {
  ...
  return (
    <nav className="bg-rose-600 border-b border-rose-600">
 ...
 */}     
         { !isLoggedIn && (
          ...
          <div className="flex items-center">
            <button
              className="flex items-center text-black bg-white hover:bg-green-500 hover:text-white rounded-md px-3 py-2"
            >
              <FaGoogle  className="fa-brands fa-google text-black mr-2 hover:text-white"></FaGoogle>
